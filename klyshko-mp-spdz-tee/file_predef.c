...
int main(){
    ...
    */
    ...
    char *cmd[] = {
    "./Fake-Offline.x",                  // The command to run
    "-d",                                // Argument for -d
    "0",                             // Value for the -d argument
    "--prime",                           // Argument for --prime
    "198766463529478683931867765928436695041",  // Hardcoded prime value
    "--prngseed",                        // Argument for --prngseed
    "1a2b3c4d5e6f7081",                  // Hardcoded seed value (first 16 characters)
    "--nbits",                           // Argument for --nbits
    "0,10000",
    "2",                           // Hardcoded value for --nbits
